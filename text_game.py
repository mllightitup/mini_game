...
def start(h, es):
    print(
        'Привет это снова я - Дэкой. Ну что готов к своему первому заданию? Видишь этот склеп на вершине холма?\n'
        'В него уже на заходили 23 года. Говорят там завелось много чудовищь.\n'
        f'Это задание должно быть легким для тебя, еще и мешок золота от {yellow}Гревиаса{color_end} получишь!\n'
        f'{h [ "name" ]} заходит в склеп и видит несколько комнат. Из каждой доносятся устрашающие звуки.\n'
